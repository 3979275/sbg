				...
				<ul class="nav sidebar-menu">
						...
						<ul class="submenu">
							...
							<li>
								<a href="/Admin/Grade/index">
									<span class="menu-text">等级列表</span>
								</a>
							</li>
						</ul>
					</li>
					...
					<li>
						<a href="#" class="menu-dropdown">
							...
							<span class="menu-text"> 团建管理 </span>
							<i class="menu-expand"></i>
						</a>

						<ul class="submenu">
							<li>
								<a href="/Admin/Group/index">
									<span class="menu-text">团建列表</span>
								</a>
							</li>
						</ul>
					</li>
					...
					<li>
						...
						<ul class="submenu">
							...
							<li>
								<a href="/Admin/Pay/ali">
									<span class="menu-text">支付宝</span>
								</a>
							</li>
						</ul>
					</li>
					...
					<li>
						...
						<ul class="submenu">
							<li>
								<a href="/Admin/Other/nav">
									<span class="menu-text">导航管理</span>
								</a>
							</li>
							<li>
								<a href="/Admin/Other/message">
									<span class="menu-text">留言管理</span>
								</a>
							</li>
							<li>
								<a href="/Admin/Other/tag">
									<span class="menu-text">标签管理</span>
								</a>
							</li>
							<li>
								<a href="/Admin/Other/link">
									<span class="menu-text">友情链接</span>
								</a>
							</li>
							<li>
								<a href="/Admin/Ad/index">
					...
					<li>
						...
						<ul class="submenu">
							<li>
								<a href="/Admin/Log/order">
									<span class="menu-text">订单日志</span>
								</a>
							</li>
							<li>
								<a href="/Admin/Log/operation">
									<span class="menu-text">操作日志</span>
								</a>
							</li>
							<li>
								<a href="/Admin/Log/system">

							...
							<div class="widget radius-bordered">
								...
								<div class="widget-body">
									<div class="table-toolbar">
										<a href="/Admin/Product/create" class="btn btn-default shiny">
										...
										<table class="table table-striped table-hover table-bordered dataTable no-footer" id="editabledatatable" role="grid" aria-describedby="editabledatatable_info">
											<thead class="bordered-darkorange">
												<tr role="row">
													...
													<th class="sorting_disabled" rowspan="1" colspan="1" aria-label="" style="width: 8%;">
														商品名称
													</th>
													<th class="sorting_asc" tabindex="0" aria-controls="editabledatatable" rowspan="1" colspan="1" aria-label="number : activate to sort column descending" style="width: 3%;" aria-sort="ascending">
														商品编号
													</th>
													<th class="sorting" tabindex="0" aria-controls="editabledatatable" rowspan="1" colspan="1" aria-label="price : activate to sort column ascending" style="width: 3%;">
														商品单价
													</th>
													<th class="sorting_disabled" rowspan="1" colspan="1" aria-label="" style="width: 3%;">
														市场价格
											...
											<tbody>
												...
												@else
													<tr role="row" class="odd">
														<td class="center" colspan="12">暂无数据，请添加数据！</td>
													</tr>
												@endif
